...
namespace Ambev.DeveloperEvaluation.Unit.Application.ProductTest.GetProduct;
    ...
    public class GetProductResultTests
    {
        [Fact]
        public void GetProductResult_Should_SetAndGetPropertiesCorrectly()
        {
            // Arrange
            ...
            Assert.Equal(branchName, result.ProductName);
            Assert.Equal(createAt, result.CreateAt);
            Assert.Equal(updateAt, result.UpdateAt);
        }

        [Fact]
        public void GetProductResult_Should_AllowNullUser()
        {
            // Arrange
            var result = new GetProductResult();
        ...
        [Fact]
        public void GetProductResult_Should_SetUserCorrectly()
        {
            // Arrange
